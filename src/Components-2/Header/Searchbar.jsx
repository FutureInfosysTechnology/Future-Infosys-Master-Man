    ...
    return (
        <div className="search-bar">
            ...
            <Modal overlayClassName="custom-overlay" isOpen={modalIsOpen}
                className="custom-modal-vendorGST" contentLabel="Modal">
            ...
            <Modal overlayClassName="custom-overlay" isOpen={modalIsOpen1}
                ...
                <div className="custom-modal-content">
                    ...
                    <div className='container2'>
                        ...
                        <Tabs defaultActiveKey="details" className="tab-center">
                            ...
                            <Tab eventKey="status" title="Status and Scans" className="tab-center">
                                {trackingData.length > 0 ? (
                                    trackingData.map((record, index) => (
                                        <div key={index}>
                                            <p><b style={{ color: "white", paddingLeft: "10px" }}>Status and Scans</b></p>
                                                    ...
                                                    <tbody>
                                                        {record.StatusEntry && record.StatusEntry.length > 0 ? (
                                                            record.StatusEntry.map((entry, idx) => (
                                                                <tr key={idx}>
                                                                    <td className="td-width">{entry.Destination_name}</td>
                                                                    <td className="td-width">{entry.Status}</td>
                                                                    <td className="td-width">{entry.DelvDt}</td>
                                                                    <td className="td-width">{entry.DelvTime}</td>
                                                                </tr>
                                                            ))
                                                        ) : (
                                                            <tr>
