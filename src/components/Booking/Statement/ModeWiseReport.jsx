...
function ModeWiseReport() {
    ...
    const reportOptions = [
        { value: "All REPORT DATA", label: "All REPORT DATA" },
    ];
    const getAllMode = [
                    ...
                    <div className="row g-3 mb-3">
                        <div className="col-12 col-md-4">
                            ...
                            <Select
                                ...
                                value={formData.report ? reportOptions.find(c => c.value === formData.report) : null}
                                onChange={(selectedOption) =>
                                    setFormData({ ...formData, report: selectedOption ? selectedOption.value : "" })
                                }
                        ...
                        <div className="col-12 col-md-4">
                            <h6 className="form-label mb-0" style={{ fontSize: "0.85rem", color: "#212529" }}>Select Mode</h6>
                            <Select
                                required
                                className="blue-selectbooking"
                                classNamePrefix="blue-selectbooking"
                                options={getAllMode}
                                value={formData.mode ? getAllMode.find((c)=>c.value===formData.mode):null}
                                onChange={(selected)=>
                        ...
                        <div className="col-12 col-md-4">
                            <h6 className="form-label mb-0" style={{ fontSize: "0.85rem", color: "#212529" }}>Vendor Name</h6>
                            <Select
                                required
                                options={allVendor}
                                value={
                                    formData.vendorCode
                                        ? allVendor.find(c => c.value === formData.vendorCode)
                                        : null
                                }
                                onChange={(selectedOption) =>
                                    setFormData({
