...
import { postApi } from "../../Admin Master/Area Control/Zonemaster/ServicesApi";

const ExcelImportBulk = () => {
  ...
  const handleUpload = async () => {
    ...
    for (let i = 0; i < MAX_CALLS; i++) {
      ...
      try {
        const response = await postApi('/Booking/ExcelimportBulkData', { exelData: chunk });
...
export default ExcelImportBulk;
